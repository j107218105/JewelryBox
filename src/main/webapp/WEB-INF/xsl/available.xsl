			...
			<TBODY>
				<xsl:for-each select="row">
					<TR>
						...
						<TD>
							<A class="ajax fontAwesome" title="參與" href="participate/{id}.json">&#xF058;</A>
							<I>&#160;</I>
							<A class="ajax fontAwesome" title="棄權" href="forfeit/{id}.json">&#xF057;</A>
						</TD>
					</TR>
				</xsl:for-each>
			</TBODY>
